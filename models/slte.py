...
class SLTE(nn.Module):
    ...
    def __init__(self, encoder_spec, imnet_spec=None, hidden_dim=256,**kwargs):
        ...
        self.imnet = models.make(imnet_spec, args={'in_dim': hidden_dim+2})
    ...
    def query_rgb(self, coord, cell=None):
        ...
        for vx in vx_lst:
            for vy in vy_lst:
                ...
                inp = torch.mul(q_coef, q_freq) # (b,q,c) # 逐元素相乘
                inp = torch.cat((inp,q_coord), dim=-1) # (b,q,2+c)
